...
set(LIB_HAL_STM32F103_COMMON_CSRC
        )

set(LIB_HAL_STM32F103_HAL_CSRC
        ...
        hal/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_spi_ex.c
...
set(LIB_HAL_STM32F103_CSRC
    ${LIB_HAL_STM32F103_COMMON_CSRC}
    ${LIB_HAL_STM32F103_HAL_CSRC})


# Set the used include path for lib_app build
set(LIB_HAL_STM32F103_INC
    ${LIB_BSP_STM32F103_INC_DIR})

# Set include paths.
# The value LIB_CORE_HAL_INC is set by lib_hal_stm32f103_exp.cmake
include_directories(
    ${LIB_HAL_STM32F103_INC}
		${LIB_CORE_HAL_INC})
