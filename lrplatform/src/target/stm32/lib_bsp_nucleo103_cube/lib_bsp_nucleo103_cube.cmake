...
#
include(lib_bsp_nucleo103_cube_exp.cmake)

enable_language(ASM)

# Set the common asm sources
set(LIB_BSP_NUCLEO103_CUBE_COMMON_ASRC
		startup_stm32f103xb.s)
		
# Set the common sources
set(LIB_BSP_NUCLEO103_CUBE_COMMON_CSRC
		custom_board.c)

set(LIB_BSP_NUCLEO103_CUBE_COMMON_CPPSRC
        )

# Set the cube sources
set(LIB_BSP_NUCLEO103_CUBE_GEN_CSRC
		hal/adc.c
        hal/can.c
        hal/gpio.c
        hal/main.c
...
set(LIB_BSP_NUCLEO103_CUBE_CSRC
		${LIB_BSP_NUCLEO103_CUBE_GEN_CSRC}
		${LIB_BSP_NUCLEO103_CUBE_COMMON_ASRC}
        ${LIB_BSP_NUCLEO103_CUBE_COMMON_CSRC}
        ${LIB_BSP_NUCLEO103_CUBE_COMMON_CPPSRC})
...
set(LIB_BSP_NUCLEO103_CUBE_INC ${LIB_BSP_NUCLEO103_CUBE_INC_DIR})
