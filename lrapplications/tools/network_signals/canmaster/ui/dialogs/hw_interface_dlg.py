...
class HardwareInterfaceDialog(wx.Dialog):
    ...
    def _initUI(self):
        ...
        self._cmbInterface = wx.Choice(self._panel, choices=['COM1', 'COM2', 'COM3', 'COM4', 'COM5'])
        self._cmbInterface.SetSelection(3)
        self._sizer.Add(self._cmbInterface, pos=(2, 1), span=(1, 5), flag=wx.TOP | wx.EXPAND, border=10)
        ...
        self._sizer.Add(self._cmbBaudrate, pos=(3, 1), span=(1, 5), flag=wx.TOP | wx.EXPAND, border=10)
        ...
        self._sizer.Add(boxsizer, pos=(4, 0), span=(1, 5), flag=wx.EXPAND | wx.TOP | wx.LEFT | wx.RIGHT , border=10)

        # Create the dialog buttons
        helpButton = wx.Button(self._panel, label='Help')
        helpButton.Enable(False)
        self._sizer.Add(helpButton, pos=(6, 0), flag=wx.LEFT, border=10)

        okButton = wx.Button(self._panel, label="Ok")
        okButton.Bind(wx.EVT_BUTTON, self._onOK)
        self._sizer.Add(okButton, pos=(6, 3))

        cancelButton = wx.Button(self._panel, label="Cancel")
        cancelButton.Bind(wx.EVT_BUTTON, self._onCancel)
        self._sizer.Add(cancelButton, pos=(6, 4), span=(1, 1), flag=wx.BOTTOM|wx.RIGHT, border=10)
