...
{
	pCANFrame->txHeader.ExtId = CAN_ID_EngineCtrlFront_Alive;
...
{
	pCANFrame->txHeader.ExtId = CAN_ID_Engine_Speed_Front;
	pCANFrame->txHeader.StdId = 0;
	pCANFrame->txHeader.IDE   = CAN_ID_EXT;
...
{
	pCANFrame->txHeader.ExtId = CAN_ID_Wheel_Speed_Front;
	pCANFrame->txHeader.StdId = 0;
	pCANFrame->txHeader.IDE   = CAN_ID_EXT;
