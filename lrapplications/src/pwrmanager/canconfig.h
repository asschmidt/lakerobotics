 ...
 * Bit 19-0: Message ID
 */
#define MAKE_CAN_ID(srcId, dstId, msgid)		((((uint32_t)(dstId & 0x0F) << 24) | ((uint32_t)(srcId & 0x0F) << 20) | (uint32_t)(msgid & 0x7FFFF)) | CAN_EFF_FLAG)
#define MAKE_BROADCAST_CAN_ID(srcId, msgid)		((uint32_t)(MAKE_CAN_ID(srcId, 0x00, msgid) | (((uint32_t)0x01 << 28))))
